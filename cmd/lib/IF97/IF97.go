...
type IF97 struct {
	...
	region     region.IF97er
}

var IF97test IF97calc = &IF97{}
 ...
 * @return  RangeError
 */
func (if97 *IF97) defaultDielectricConstantRhoT(rho float64, T float64) (float64, error) {
 ...
 */
func (if97 *IF97) defaultDynamicViscosityRhoT(rho float64, T float64) (float64, error) {
...
func (if97 *IF97) defaultThermalConductivityRhoT(rho float64, T float64) float64 {
...
func (if97 *IF97) defaultThermalDiffusivityPH(p float64, h float64) (float64, error) {
	...
	lambda, err := if97.ThermalConductivityRhoT(rho, T)
	if err != nil {
		return -1, err
	}
	var cp float64
